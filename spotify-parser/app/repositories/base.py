...
class BaseRepository(Generic[Model]):
    ...
    def get_count(self, *expressions: BinaryExpression[Any] | ColumnOperators) -> Optional[int]:
    ...
    def get(self, pk: UUID, options: Optional[Sequence[ORMOption]] = None) -> Model | None:
        return self._session.get(self.__model__, pk, options=options)

    def update(self, *expressions: BinaryExpression[Any] | ColumnOperators, **kwargs: Any) -> Sequence[Model]:
    ...
    def delete(self, *expressions: BinaryExpression[Any] | ColumnOperators) -> None:
    ...
    def check_exists(self, *expressions: BinaryExpression[Any]) -> bool:
